...
export default function ProjectCard({ project }: ProjectCardProps) {
  return (
    <article className="mt-8 rounded-[10px] border border-rule bg-surface p-6 transition-colors duration-120 ease first:mt-0 hover:border-accept/40 motion-reduce:transition-none">
